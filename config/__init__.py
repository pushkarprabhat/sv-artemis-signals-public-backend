...
EMAIL_CONFIG = {
    ...
    'recipient_emails': [e.strip() for e in os.getenv('RECIPIENT_EMAILS', ALERT_EMAIL).split(',') if e.strip()],
...
MAX_WORKERS = 8                 # Parallel workers for internal strategies
